#
#  Be sure to run `pod spec lint UnifiedJump.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source_files  = "UnifiedJump", "UnifiedJump/**/*.{h,m}"
  s.exclude_files = "UnifiedJump/Exclude"

  # s.public_header_files = "UnifiedJump/**/*.h"
